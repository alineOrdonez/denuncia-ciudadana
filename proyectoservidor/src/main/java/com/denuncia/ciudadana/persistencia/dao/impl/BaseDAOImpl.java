...
import com.denuncia.ciudadana.persistencia.dao.BaseDAO;
...
public class BaseDAOImpl<T, PK extends Serializable> implements BaseDAO<T, PK> {
	...
	public T findByPK(PK id) throws PersistenciaException {
		try {
			...
			throw new PersistenciaException("Excepci&oacute;n en BD", e);
		}
	}
	...
	public boolean exists(PK paramPK) throws PersistenciaException {
		try {
			...
			throw new PersistenciaException("Excepcion en BD", e);
		}
	}
